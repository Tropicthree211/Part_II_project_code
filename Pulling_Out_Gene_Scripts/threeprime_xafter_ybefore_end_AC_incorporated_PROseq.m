...
% 
% PROseq_sample1 = importdata([dataloaddir 'ulku_dst1del_PROseq_1.mat']);
...
% 
% PROseq_sample1 = importdata([dataloaddir 'ulku_xrn1del_PROseq_1.mat']);
...
% 
% PROseq_sample1 = importdata([dataloaddir 'ulku_SPT4AA_PROseq_1.mat']);
...
% 
% PROseq_sample1 = importdata([dataloaddir 'ulku_SPT5AA_PROseq_1.mat']);
...
% 
% PROseq_sample1 = importdata([dataloaddir 'ulku_SPT4AADMSO_PROseq_1.mat']);
...
Normalised_PROseq_Bins_Matrix = Shape_normalisation_function(PROseq_Bins10bp_avg); %should probably integrate this into the code but i thought i was cool making a function
% %remove NaNs
