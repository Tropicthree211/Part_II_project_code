...
for i = 1:16
    ...
    %pulling out 1000bp after the end of gene%
    chromosomei_startpoints = chromosomei_genepos{1,1}(:,2)  ;
...
for j = 1:16
    ...
    %pulling out the 1000bp after end of genes%
    chromosomej_startpoints = chromosomej_genepos{1,1}(:,1)  ;
    %start points - 999 gives  1000 bases after of reversed gene%
