...
for i = 1:16
    ...
    %pulling out 1000bp before the end of gene%
    chromosomei_startpoints = chromosomei_genepos{1,1}(:,2) - 999 ;
    
    %start pos + 999 gives last 1000 bases%
...
for j = 1:16
    ...
    %pulling out the 1000bp before end of genes%
    chromosomej_startpoints = chromosomej_genepos{1,1}(:,1) + 999 ;
    %start points - 999 gives last 1000 bases of reversed gene%
