...
saveas(gcf, append(mutant1, datatype, 'metagene_forward'), 'jpeg')
saveas(gcf, append(mutant1, datatype, 'metagene_forward'), 'fig')
figure
plot(metagene_reverse')
title('metagene reverse')
saveas(gcf, append(mutant1, datatype, 'metagene_reverse'), 'jpeg')
saveas(gcf, append(mutant1, datatype, 'metagene_reverse'), 'fig')
...
saveas(gcf, append(mutant1, datatype, 'metagene_forward2'), 'jpeg')
saveas(gcf, append(mutant1, datatype, 'metagene_forward2'), 'fig')
figure
plot(metagene_reverse2)
title('metagene reverse repeat')
saveas(gcf, append(mutant1, datatype, 'metagene_reverse2'), 'jpeg')
saveas(gcf, append(mutant1, datatype, 'metagene_reverse2'), 'fig')
...
saveas(gcf, append(mutant1, datatype, 'normalised_metagene'), 'fig')
saveas(gcf, append(mutant1, datatype, 'normalised_metagene'), 'jpeg')
%% NaN to zeros 
...
trand = t(randperm(numel(t),10000));
lrand = mrand +10 ;
smval = [srand mrand trand lrand]; 
%% Coding model using the parameters 
profile_matrix = zeros(size(smval, 1), size(Normalised_NETseq_Bins_Matrix, 2));
for smplctr = 1:1: size(profile_matrix, 1)
    for x = 1:size(profile_matrix,2)
        
        profile_matrix(smplctr, x) = (1/smval(smplctr, 1)*(6.3)^(1/2))*exp(-1/2*((x-smval(smplctr, 2)/smval(smplctr,1))^2))...
            + (1/smval(smplctr, 3)*(6.3)^(1/2))*exp(-1/2*((x-smval(smplctr, 4)/smval(smplctr,3))^2));
...
%%
save(append('/home/orie3770/Modelling/', 'norm2peak_modeled_LIS', mutant1, 'PROseq_profiles', string(Current_modelling_job), '.mat'), ...
...
for gctr =  1:1:size(Normalised_NETseq_Bins_Matrix, 1) % go through each gene in turn
    for pctr = 2:1:size(Normalised_NETseq_Bins_Matrix, 2) % go through each 10bp position in the gene
        if max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (2<=pctr) && (pctr<6) &&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 1 ;
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (6<=pctr) && (pctr<10) &&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 2 ;            
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (10<=pctr) && (pctr<14)&& mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 3 ;
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) &&(14<=pctr) && (pctr<18)&&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 4 ;
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) &&(18<=pctr) && (pctr<22) &&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 5 ;
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (22<=pctr) && (pctr<26) &&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 6 ;
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (26<=pctr) && (pctr<30)&& mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 7 ;
            
            %extend size of area with more elseifs
            
       elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (30<=pctr) && (pctr<34)&& mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 8 ;
       
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (34<=pctr) && (pctr<38)&&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 9 ;  
       
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (38<=pctr) && (pctr<42)&&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 10; 
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (42<=pctr) && (pctr<46)&&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 11; 
            
        elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (46<=pctr) && (pctr<50)&&  mindistprofiles(gctr,pctr+10) > mean(mindistprofiles(gctr,:))
            normpeakclasses(gctr, 1) = 12; 
            %don;t want genes with second peak out of bounds if it exists 
%         elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (50<=pctr) && (pctr<54)
%             normpeakclasses(gctr, 1) = 13;     
%             
%         elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (54<=pctr) && (pctr<58)
%             normpeakclasses(gctr, 1) = 14;   
%           
%         elseif max(mindistprofiles(gctr,:)) == mindistprofiles(gctr, (pctr)) && (58<=pctr) && (pctr<60)
...
% 
%  NETseq_sample = importdata([dataloaddir 'LIS_PROseq_spt4.mat']);
%  NETseq_sample2 = importdata([dataloaddir 'LIS_spt4del_PROseq.mat']);
NETseq_sample1 = importdata([dataloaddir 'LIS_PROseq_spt4del_amended.mat']);   %increased number of zeros to reflect size of chromosomes and to allow use of Harry's annotations.
NETseq_sample2 = importdata([dataloaddir 'LIS_PROseq_spt4del_amended.mat']);
% isn't actually NETseq sample just calling it that so it plays nice with
% my code, should eventually move to generic naming of intermediates but
...
plot(metagene_forward')
title('metagene forward')
saveas(gcf, append(mutant, datatype1, 'metagene_forward'), 'jpeg')
saveas(gcf, append(mutant, datatype1, 'metagene_forward'), 'fig')
figure
plot(metagene_reverse')
title('metagene reverse')
saveas(gcf, append(mutant, datatype1, 'metagene_forward'), 'jpeg')
...
plot(metagene_forward2)
title('metagene forward repeat')
saveas(gcf, append(mutant, datatype1, 'metagene_forward2'), 'jpeg')
saveas(gcf, append(mutant, datatype1, 'metagene_forward2'), 'fig')
figure
plot(metagene_reverse2)
title('metagene reverse repeat')
saveas(gcf, append(mutant, datatype1, 'metagene_forward2'), 'jpeg')
...
plot(metagene_Normalised)
title('normalised metagene')
saveas(gcf, append(mutant, datatype1, 'metagene_norm'), 'jpeg')
saveas(gcf, append(mutant, datatype1, 'metagene_norm'), 'fig')
%% NaN to zeros 
% Normalised_NETseq_Matrix(isnan(Normalised_NETseq_Matrix)) = 0; converts
% Nans to zeros rather than removing
...
filename = append(mutant1, datatype, mutant, datatype1, 'norm2peakmodelled300b300a',string(n));
