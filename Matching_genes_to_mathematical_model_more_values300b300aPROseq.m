...
%%
unix(append('mv ',mutant1, datatype, mutant, datatype1, 'norm2peakmodelled300b300a' , '*', ' ./Current_Modelling_Job', string(Current_modelling_job)))
%
toc